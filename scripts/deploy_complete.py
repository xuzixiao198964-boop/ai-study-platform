...
def main():
    ...
    try:
        ...
        # 4. 上传pubspec.yaml
        print("上传 pubspec.yaml")
        sftp.put(
            str(base_dir / "mobile/pubspec.yaml"),
            "/opt/ai-study-platform/mobile/pubspec.yaml"
        )
        ...
        # 6. 配置git
        print("\n=== 配置git ===")
        ssh.exec_command("git config --global --add safe.directory /root/flutter")
